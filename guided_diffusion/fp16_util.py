...
def convert_module_to_quint4(l):
    if isinstance(l,(nn.Conv1d,nn.Conv2d,nn.Conv3d)):
        l.weight.data=l.weight.data.to(th.quint4x2);
        if l.bias is not None:
            l.bias.data=l.bias.data.to(th.quint4x2);
            
def convert_module_to_uint8(l):
    if isinstance(l,(nn.Conv1d,nn.Conv2d,nn.Conv3d)):
        l.weight.data=l.weight.data.to(th.uint8);
        if l.bias is not None:
            l.bias.data=l.bias.data.to(th.uint8);
            
def convert_module_to_f16(l):
    if isinstance(l,(nn.Conv1d,nn.Conv2d,nn.Conv3d)):
        l.weight.data=l.weight.data.to(th.float16);
        if l.bias is not None:
            l.bias.data=l.bias.data.to(th.float16);
            
def convert_module_to_f32(l):
    if isinstance(l,(nn.Conv1d,nn.Conv2d,nn.Conv3d)):
        l.weight.data=l.weight.data.to(th.float32);
        if l.bias is not None:
            l.bias.data=l.bias.data.to(th.float32);
            
def convert_module_to_f64(l):
    if isinstance(l,(nn.Conv1d,nn.Conv2d,nn.Conv3d)):
        l.weight.data=l.weight.data.to(th.float64);
        if l.bias is not None:
            l.bias.data=l.bias.data.to(th.float64);
